...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 18 Mars 2016 à 01:20
...
INSERT INTO `disque` (`id`, `nom`, `idUtilisateur`) VALUES
(1, 'Datas', 1),
(2, 'System', 1),
(3, 'Jacob datas', 2),
(4, 'System', 2),
...
(1, 'Backup', 'Sauvegarde journalière de toutes les données sur un disque de sauvegarde', 0.00),
...
INSERT INTO `utilisateur` (`id`, `login`, `mail`, `password`, `nom`, `prenom`, `tel`, `admin`) VALUES
(1, 'eAllman', 'eric.allman@gmail.com', 'phalcon', 'Allman', 'Eric', '', 1),
(2, 'jAppelbaum', 'jacob.appelbaum@gmail.com', '0000', 'Appelbaum', 'Jacob', NULL, 0),
(3, 'kdMitnick', 'kd.mitnick@gmail.com', '0123456789', 'Mitnick', 'Kevin David', NULL, 0),
(4, 'djbernstein', 'djbernstein@gmail.com', 'azertyuiop', 'Bernstein', 'Daniel J.', '1', 1);
